...
/*
	byte botao = Byte.parseByte(JOptionPane.showInputDialog("Entre com umas das opções \n 1.Imposto \n2.Novo Salário \n3.Classificação"));
	
	if (botao == 1) {
		float salario = Float.parseFloat(JOptionPane.showInputDialog("Entre com salário"));
		if (salario <= 500) {
			float imposto = (float)0.05 * salario;
			System.out.println("Seu salário é " + salario + " o imposto será 5% = " + imposto );
		} else if (salario < 851){
			float imposto = (float)0.10 * salario;
			System.out.println("Seu salário é " + salario + " o imposto será 10% = " + imposto );
		} else {
			float imposto = (float)0.15 * salario;
			System.out.println("Seu salário é " + salario + " o imposto será 15% = " + imposto );
		}
	}	else if (botao == 2) {
		float salario = Float.parseFloat(JOptionPane.showInputDialog("Entre com salário"));
		if (salario > 1500) {
	...
	/*
	System.out.println("Entre com uma das alternativas:");
