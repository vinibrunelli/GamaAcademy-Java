...
public class DecisaoEncadeada {
	...
	public static void main(String[] args) {
		 ...
		 * -Nota 2
		 * -Média
		 * -Parabés somente se > que 6
		 */


		/*Capturar tb a qnt de faltas
		só sera aprovado abaixo de 20 faltas
		Media maior que 6, faltas abaixo de 20*/


		/* Maneira menos otimizada
		if (media >= 6  && faltas < 20) {
			System.out.println("Sua nota de "+ nomeDisciplina + " foi "+ media +" Parabéns, você foi aprovado!");
		...
		if (faltas > 20) {
			...
			if (media >= 6  ) {
				...
				System.out.println("Sua nota foi " + media + ", terá que fazer Exame");
			}	
		}
		...
		/*
		 * Usamos decisões encadeadas quando analisamos dois dados distintos ( media e faltas)
		 * 
		 */
