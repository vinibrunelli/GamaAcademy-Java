...
public class TesteTipos {
	public static void main(String[] args) {
		...
		System.out.printf("O Valor acrecido de imposto é R$ %.2f", produtoComImposto);
		 //valor do imposto isolado
		System.out.printf("O Valor do imposto é R$ %.2f", valorImpostoUnitario);
		 //total com imposto
		System.out.printf("O total com imposto é R$ %.2f", totalComImposto);
		 //total sem imposto
		System.out.printf("O total sem imposto é R$ %.2f", totalSemImposto);
