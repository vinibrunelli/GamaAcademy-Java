...
public class DoExemplo {
 ...
 O Jogador 1 vai colocar o numro e o jogador 2 vai ter que acertar o numero
  -Missão 1 -> De dicas (alto ou baixo)
  -Missão 2 -> acrescentar na msg parabens, qnts tentativas ate acerto
  ...
  Dica vai ter que ter uma variavel para contar
		...
		do {
			...
			System.out.println("Parabésn você acertou na " + tentativa + " vez!!!");
		...
		do {
			...
			if (operacao.equals("+") == true) {
				...
				System.out.println("Você não digitou um caracter permitido.");
			}
