...
//new Endereco() -->(Construtor)	sempre tem que ter o nome da classe
	...
	/* o construtor pode ser usado par preencher valores padrao
	 *  public aluno (){
	 *  nome ="Vazio";
	 *  }
	 *  
	 *  ou para receber um dado direto objeto
	 *  
...
//----------------- TESTE  Aluno 2 ----------------------//	
		...
		/* As linhas estão quebradas mas estao no mesmo (,,,,) separados por virgula
	...
	// O FrontEnd que encontrar só o bairro e cidade do Aluno
